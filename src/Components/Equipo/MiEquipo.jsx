...
const MiEquipo = () => {
  const navigate = useNavigate();
    ...
    const ficharJugador = () => {
      navigate('/nuevoFichaje')
    }

    const editarEquipo = () => {  
      navigate('/editarEquipo')
    }
    ...
    <div className="min-h-screen flex flex-col"> 
        ...
        <div className='m-auto flex flex-col justify-center items-center'>
            <div className="grid grid-cols-5 grid-rows-5 gap-4">
              ...
              <div className="col-span-2 row-span-2 row-start-3 flex flex-col items-center max-w-100 border-2 rounded-2xl bg-gray-700/60 text-amber-50 hover:text-pink-500/60 hover:border-pink-500/60 cursor-pointer" onClick={ficharJugador}>
                <h1 className='text-3xl'>Nuevo fichaje</h1>
                <img src="/Fichaje.webp" className='jugador rounded-lg w-64 h-45 m-2' alt="" />
              </div>

              <div className="row-span-2 col-start-3 row-start-3 border-2 rounded-2xl flex flex-col items-center max-w-46 bg-gray-700/60 text-amber-50 hover:text-pink-500/60 hover:border-pink-500/60 cursor-pointer" onClick={editarEquipo}>
